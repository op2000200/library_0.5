...
"border-radius: 30px;"));
        ...
        label_12->setGeometry(QRect(100, 780, 49, 16));
...
"border-radius: 20px;"));
    ...
    void retranslateUi(QWidget *bibli)
    {
        ...
        pushButton_6->setText(QCoreApplication::translate("bibli", "\320\237\321\200\320\270\320\275\321\217\321\202\321\214", nullptr));
